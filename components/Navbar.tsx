    ...
    <nav className="w-full bg-white border-b border-gray-100 h-16 flex items-center px-4 md:px-24 justify-between sticky top-0 z-50">
      ...
      <div className="flex items-center gap-6 md:gap-10">
        ...
        <div className="hidden md:flex items-center">
          <Link href="/dashboard" className="text-blue-700 font-semibold text-sm hover:opacity-80 transition-opacity">
            Shop
          </Link>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 md:gap-5">
        ...
        <div className="hidden md:block relative" ref={dropdownRef}>
          ...
          >
            <img src={dummyAvatarUrl} alt="Avatar" className="h-full w-full object-cover" />
          </button>
          ...
          {isDesktopDropdownOpen && (
            <div className="absolute right-0 mt-3 w-52 bg-white rounded-2xl shadow-lg border border-gray-100 py-2 z-50">
              <div className="px-4 py-3 border-b border-gray-100">
                ...
                <p className="text-sm font-bold text-slate-800 truncate capitalize">{username}</p>
              </div>
              <div className="pt-1">
                <button
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-16 left-0 w-full bg-white border-b border-gray-100 shadow-xl py-6 px-6 flex flex-col gap-5 md:hidden z-40 animate-in slide-in-from-top duration-200">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Navigasi Halaman</span>
            <Link 
              href="/dashboard" 
