  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <p className="text-gray-400 animate-pulse text-sm font-medium">Memuat detail produk...</p>
      </div>
    );
  }
    ...
    <div className=" px-4 md:px-24 py-8 bg-white min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 pb-4 border-b border-gray-100 gap-4">
        ...
        <div className="text-xs font-semibold tracking-wider text-slate-800 uppercase flex items-center gap-2">
          <Link href="/dashboard" className="text-gray-400 hover:text-blue-600 transition-colors">Catalog</Link>
          <span className="text-gray-300">/</span>
          <span className="text-gray-400">{product.category}</span>
          <span className="text-gray-300">/</span>
          <span className="text-slate-900 truncate max-w-50 sm:max-w-xs">{product.title}</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col">
          ...
          <div className="flex items-center justify-center gap-8 text-xs text-gray-400 font-medium pt-2 border-t border-gray-100">
            ...
            <span className="flex items-center gap-1.5">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99్‌" />
              </svg>
              30-Day Returns
            </span>
          </div>
