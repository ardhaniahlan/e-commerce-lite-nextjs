    ...
    <div className="px-4 md:px-24 py-10 bg-white min-h-screen text-slate-900">
      ...
      {items.length === 0 ? (
        <div className="text-center py-24 flex flex-col items-center justify-center gap-4">
          <p className="text-gray-400 text-sm font-medium">Keranjang belanja Anda masih kosong.</p>
          <Link href="/dashboard" className="px-6 py-3 bg-[#0044CC] text-white text-xs font-bold rounded-xl hover:bg-blue-800 transition-colors shadow-sm">
            Mulai Belanja
          </Link>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
                  ...
                  <div className="flex sm:flex-col items-center sm:items-end justify-between w-full sm:w-auto gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center bg-white border border-gray-200 rounded-xl px-3 py-1.5 shadow-xs">
                        ...
                        <span className="text-xs font-bold text-slate-800 px-3">{item.quantity}</span>
                        <button 
                          onClick={() => updateQuantity(item.id, item.quantity + 1)} 
                          className="text-gray-400 hover:text-slate-900 font-bold px-1 text-sm transition-colors"
                        >
            ...
            <div className="bg-[#F9FAFC] border border-dashed border-gray-300 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 mb-0.5">Have a promotional code?</h4>
                  <p className="text-xs text-gray-500">Enter it to unlock exclusive discounts. (Coba: <span className="font-semibold text-slate-700">CODE10</span>)</p>
                </div>
              </div>

              <form onSubmit={handleApplyPromo} className="flex items-center w-full sm:w-auto bg-white border border-gray-200 rounded-2xl p-1 shadow-xs">
                <input
                  type="text"
                  placeholder="CODE10"
                  value={promoCode}
                ...
                />
                <button type="submit" className="bg-slate-900 text-white text-xs font-bold px-4 py-2 rounded-xl hover:bg-[#0044CC] transition-colors">
                  Apply
                </button>
              </form>
            </div>
          ...
          <div className="lg:col-span-5 bg-[#121824] text-white p-8 rounded-3xl shadow-xl flex flex-col">
            ...
            <div className="flex flex-col gap-4 text-xs font-medium text-gray-300 mb-6 pb-6 border-b border-gray-800">
              ...
              <div className="flex justify-between items-center">
                <span>Shipping</span>
                <span className="font-bold text-gray-400 uppercase tracking-wider">Calculated Next</span>
              </div>
              <div className="flex justify-between items-center">
                <span>Tax Estimate</span>
                <span className="font-bold text-white">${taxEstimate.toFixed(2)}</span>
              </div>
              {discount > 0 && (
            ...
            <div className="flex items-baseline justify-between mb-8">
              <div>
                <span className="text-[10px] font-bold tracking-widest text-gray-400 uppercase block mb-0.5">Total Amount</span>
            ...
            <button className="w-full bg-[#0044CC] text-white font-bold py-4 px-6 rounded-2xl hover:bg-blue-700 transition-all shadow-md flex items-center justify-center gap-2 mb-3">
              Checkout Now
            ...
            <div className="grid grid-cols-3 gap-2 pt-6 border-t border-gray-800/80 text-center">
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-[10px] font-bold text-gray-400 tracking-wider">SECURE</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-gray-400">
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-.75a2.25 2.25 0 00-2.25-2.25H6.75A2.25 2.25 0 004.5 6.375v10.5m15 0H5.25m14.25 0h1.5c.621 0 1.125-.504 1.125-1.125v-3.75a4.5 4.5 0 00-1.125-2.625l-2.25-2.25a2.25 2.25 0 00-1.59-.66H13.5" />
                </svg>
                <span className="text-[10px] font-bold text-gray-400 tracking-wider">TRACKED</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-gray-400">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
                </svg>
                <span className="text-[10px] font-bold text-gray-400 tracking-wider">30D RETURN</span>
              </div>
            </div>
